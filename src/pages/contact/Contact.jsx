...
const Contact = () => {
  return (
    ...
    <Header title="Get In Touch" image={HeaderImage}>
      ...
      culpa inventore aliquam esse vitae tenetur voluptate repellendus natus maxime deleniti in quis animi quo tempore labore eum atque accusantium.
    </Header>
    <section className="contact">
      <div className="container contact__container">
        <div className="contact__wrapper">
          <a href="mailto:ricsaniosdev@gmail.com" target="_blank" rel='noreferrer noopener'><MdEmail /></a>
